...
import { Bell, FileDown, Search, X, Eye} from "lucide-react";
...
export default function CoachesTable() {
  ...
  const [currentUserForAssignment, setCurrentUserForAssignment] = useState<
    string | null
  >(null);
  ...
  const AssignmentModal = () => {
    ...
    const currentUser = usersData.find(
      (u) => u.id === currentUserForAssignment
    );
    ...
    const availableAssignees = coachesList.map((coach) => {
      ...
      const currentAssignment = currentUserAssignedImages.find(
            ...
            <TableBody className="overflow-visible relative z-0">
              {currentRecords.map((user) => (
                ...
                >
                  ...
                  <TableCell>
                    <Button variant="icon-only" onClick={() => navigate("consultant-view")}>
                    <Eye />
                    </Button>
                  </TableCell>
                  <TableCell>
