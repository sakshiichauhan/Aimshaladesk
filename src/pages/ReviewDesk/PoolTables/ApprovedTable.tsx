...
import { ApprovedReviews, coachesList } from "@/data/Data";
import { cn } from "@/lib/utils";

export default function CoachesTable() {
    const [usersData, setUsersData] = useState(ApprovedReviews);
    ...
    const handleRowClick = (user: (typeof ApprovedReviews)[0]) => {
