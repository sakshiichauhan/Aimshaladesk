...
import { CustomInputReview, coachesList } from "@/data/Data";
import { cn } from "@/lib/utils";

export default function CustomInputTable() {
    const [usersData, setUsersData] = useState(CustomInputReview);
    ...
    const handleRowClick = (user: (typeof CustomInputReview)[0]) => {
