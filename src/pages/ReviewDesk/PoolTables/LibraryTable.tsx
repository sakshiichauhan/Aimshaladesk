...
import { LibraryReview, coachesList } from "@/data/Data";
import { cn } from "@/lib/utils";

export default function LibraryTable() {
    const [usersData, setUsersData] = useState(LibraryReview);
    ...
    const handleRowClick = (user: (typeof LibraryReview)[0]) => {
              ...
              <TableBody className="overflow-visible relative z-0">
                {currentRecords.map((user) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="text-low">{user.Library}</div>
                      <div className="text-xs text-[var(--text)]">
                        {user.id}
                      </div>
                    </TableCell>
                    <TableCell>
                      <Badge variant="standard">{user.Name}</Badge>
                    </TableCell>
