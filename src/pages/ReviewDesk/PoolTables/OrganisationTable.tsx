...
import { OrgReview, coachesList } from "@/data/Data";
import { cn } from "@/lib/utils";

export default function OrganisationTable() {
    const [usersData, setUsersData] = useState(OrgReview);
    ...
    const handleRowClick = (user: (typeof OrgReview)[0]) => {
              ...
              <TableBody className="overflow-visible relative z-0">
                {currentRecords.map((user) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="text-low">{user.organization}</div>
