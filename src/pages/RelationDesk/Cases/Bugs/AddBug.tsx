      ...
      <div>
        <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage >Add Bug Case</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="bg-[var(--background)] border shadow-none">
            <CardContent className="space-y-8">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <Input
                      placeholder='e.g., "Assessment not opening" or "Session missed" or "Bug in the app"'
                      value={subject}
              ...
              {/* 4. Bug Assignment (Optional) */}
              <section>
                <h3 className="text-sm font-semibold text-[var(--text-head)] mb-3">
                  Bug Assignment (Optional)
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
