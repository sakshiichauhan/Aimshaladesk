      ...
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-head)]">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbPage>Custom Form</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </h1>
                  ...
                  <TableCell>
                    ...
                    <TooltipProvider>
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`custom-form/${user.id}?action=approve`);
                        }}
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`custom-form/${user.id}?action=reject`);
                        }}
